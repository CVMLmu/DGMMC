...
# Load the dataset
train = CIFAR10('./datasets', download=True, train=True, transform=preprocess)
test = CIFAR10('./datasets', download=True, train=False, transform=preprocess)
...
train_path = os.path.join('datasets', 'cifar10_clip_features', 'train')
...
test_path = os.path.join('datasets', 'cifar10_clip_features', 'test')
