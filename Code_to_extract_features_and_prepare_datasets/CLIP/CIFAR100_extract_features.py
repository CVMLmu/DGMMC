...
# Load the dataset
train = CIFAR100('./datasets', download=True, train=True, transform=preprocess)
test = CIFAR100('./datasets', download=True, train=False, transform=preprocess)
...
train_path = os.path.join('datasets', 'cifar100_clip_features', 'train')
...
test_path = os.path.join('datasets', 'cifar100_clip_features', 'test')
