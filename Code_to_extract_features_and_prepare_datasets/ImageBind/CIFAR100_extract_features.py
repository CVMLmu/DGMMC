...
# Load the dataset
train = CIFAR100('./data', download=True, train=True, transform=preprocess)
test = CIFAR100('./data', download=True, train=False, transform=preprocess)
...
train_path = os.path.join('data', 'cifar100_imagebind_features', 'train')
...
test_path = os.path.join('data', 'cifar100_imagebind_features', 'test')
